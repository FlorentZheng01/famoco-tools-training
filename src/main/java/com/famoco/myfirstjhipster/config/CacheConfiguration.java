package com.famoco.myfirstjhipster.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.famoco.myfirstjhipster.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.famoco.myfirstjhipster.repository.UserRepository.USERS_BY_EMAIL_CACHE);
